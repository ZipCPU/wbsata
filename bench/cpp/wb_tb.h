...
// TICK() will advance the system (Wishbone) clock.  Other clocks (if any)
// will naturally advance at this time as well.
#define	TICK	this->tick_clk
	/*
